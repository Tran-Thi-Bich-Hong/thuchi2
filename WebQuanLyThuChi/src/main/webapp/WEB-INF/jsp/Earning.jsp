<%--
    Document   : Earning
    Created on : Aug 23, 2022, 3:59:32 PM
...
<!-- <link href="css\earning.css" rel="stylesheet" type="text/css">-->
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Quản lý chi tiêu</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb p-0 m-0">
                        <li class="breadcrumb-item"><a href="#">Trang Chủ</a></li>
                        <li class="breadcrumb-item"><a href="#">Quản lý chi tiêu</a></li>
                        <li class="breadcrumb-item active">Thêm khoản chi</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body table-responsive">
                    <h4 class="m-t-0 header-title mb-4"><b>Thêm chi tiêu</b></h4>
                    <c:url value="/earning" var="action" />
                    <form:form class="form-horizontal" method="post" action="${action}" modelAttribute="earning">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="typeEarningId" class="col-lg-2 col-form-label">Phân loại chi tiêu<span class="text-danger">(bắt buộc)</span></label>
                            <div class="col-lg-10">
                                <form:select path="typeEarningId" class="form-control" >
                                  
                                    <c:forEach items="${typeEarnings}" var="c">
...
<script src="<c:url value="/js/Earning.js" />"></script>
...
<script>
    <c:url value="/api/earning" var="endpoint" />

    window.onload = function () {
        loadEarning('${endpoint}');
    }
